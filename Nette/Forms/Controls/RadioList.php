 ...
 * @property-read Nette\Html $separatorPrototype
 * @property-read Nette\Html $containerPrototype
 */
class RadioList extends BaseControl
{
	/** @var Nette\Html  separator element template */
	protected $separator;

	/** @var Nette\Html  container element template */
	protected $container;
